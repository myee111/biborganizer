...
from vision_client import generate_facial_description
...
def add_person(name: str, reference_image_path: str, notes: str = "") -> bool:
    """
    Add a person to the database with Claude-generated facial description.
    ...
    Raises:
        ...
        ValueError: If person already exists in database
    """
    ...
    print(f"Generating facial description for {name}...")
    print("This may take a few seconds...")

    try:
        # Generate facial description using Claude
        facial_description = generate_facial_description(reference_image_path)
        ...
        print(f"Facial description preview: {facial_description[:200]}...")

        return True

    except Exception as e:
        print(f"Error generating facial description: {e}")
        return False
...
def get_all_facial_descriptions() -> Dict[str, str]:
    """
    Get mapping of names to facial descriptions for all people.

    Returns:
        Dictionary mapping person names to their facial descriptions
    """
    db = load_database()
    return {
        person['name']: person['facial_description']
        for person in db['people']
    }
